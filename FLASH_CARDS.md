...
+ __ IS A PORT BASED NETWORK ACCESS CONTROL AND IS LAYER 2 OF THE OSI MODEL.
...
+ WHAT DOES AN IDS DO?
  ...
  + `MONITORS OR SNIFFS NETWORK TRAFFIC TO DETECT AND ALERT FOR ANOMALOUS ACTIVITY. NETWORK ACTIVITY IS CHECKED AGAINST A CONFIGURATION OF SIGNATURES TO LOOK FOR.`
...
+ __ FIREWALLS WORK AT THE SESSION LAYER OF THE OSI MODEL AND MONITOR "HANDSHAKING" BETWEEN PACKETS TO DECIDE WHETER THE TRAFFIC IS LEGITIMATE.
...
+ FILL IN THE BLANK
<img width="687" height="268" alt="image" src="https://github.com/user-attachments/assets/12e49438-f726-4527-9353-4977e1fcb80b" />
...
+ __ <-> SYN SCAN IS ALSO CALLED?

  + `TCP HALF OPEN SCAN IS ALSO CALLED`
...
+ A TCP CONNECT SCAN IS LOUDER BECAUSE __. A FULL TCP CONNECTION TO A TARGET IS LIKELY TO BE LOGGED OR TRIP AN IDS AS WELL. BUT AN ADVANTAGE OF THIS SCAN IS THAT THE USER DOESNT NEED THE SAME LEVEL OF PRIVILEGES TO RUN AS THEY DO A SYN SCAN.

  + `OF THE ADDITIONAL PACKET SET TO COMPLETE THE TCP CONNECTION`
...
+ FILL IN THE BLANK
<img width="684" height="461" alt="image" src="https://github.com/user-attachments/assets/49e520d9-2934-4154-ba23-274410c8c022" />
...
+ WHAT ARE THE TWO SUBLAYERS FOR ETHERNET AT LAYER 2?
  ...
  + `LLC AND MAC (LOGIC LINK CONTROL AND MEDIA ACCESS CONTROL)`
...
+ WHAT IS CSMA/CD MAC USED FOR?

  + `ALLOWS MULTIPLE CONPUTERS TO USE A SINGLE ETHERNET CHANNEL`
